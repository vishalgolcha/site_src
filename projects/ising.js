function Ising() {
    ...
    function update() {
        ...
        graph2.addPoint(temp,Energy(),algorithm);        
    }
...
function Graph(yadd, gname) {
    var canvas = document.getElementById(gname);
    var context = canvas.getContext("2d");
...
var ising = Ising();
var graph = Graph(0,"graph");
var graph2 = Graph(0,"graph2");
// var graph3 = Graph(0, "graph3");
